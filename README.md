...
| 日期 | 记录 | 摘要 |
|---|---|---|
| 2026-08-20 | [镜像清理与部署问题修订记录](docs/optimization-logs/2026-08-20-01-镜像清理与部署问题修订记录.md) | 修复镜像清理预览范围、清理结果反馈、项目编号错位、路径挂载和日志持久化问题 |
| 2026-08-11 | [拉取日志最终显示修订记录](docs/optimization-logs/2026-08-11-04-拉取日志最终显示修订记录.md) | 拉取过程完整显示、完成后只保留 Pull complete/Pulled；修复进程等待偶发挂起 |
| 2026-08-11 | [反馈修订记录](docs/optimization-logs/2026-08-11-03-反馈修订记录.md) | 拉取日志过滤噪音行、容器行去数量、命令菜单多作用域注册、过期菜单自动删除 |
| 2026-08-11 | [UI体验优化记录](docs/optimization-logs/2026-08-11-02-UI体验优化记录.md) | 面板文字标签、Bot 命令菜单、拉取成功后自动删除过程消息 |
